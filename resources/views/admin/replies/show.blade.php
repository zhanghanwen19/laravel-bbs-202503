...
@section('content')
    <div class="tw-bg-white tw-shadow-xl sm:tw-rounded-lg tw-p-6">
        <div class="tw-grid tw-grid-cols-1 tw-gap-6">
            <div>
                <h3 class="tw-text-lg tw-font-medium tw-text-gray-900 tw-mb-4">{{ __('Reply Information') }}</h3>
                <dl class="tw-divide-y tw-divide-gray-200">
                    <div class="tw-py-4 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        ...
                        <dd class="tw-mt-1 tw-text-sm tw-text-gray-900 sm:tw-mt-0 sm:tw-col-span-2 tw-prose tw-max-w-none">{!! nl2br(e($reply->content)) !!}</dd>
                    </div>
                    <div class="tw-py-4 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        <dt class="tw-text-sm tw-font-medium tw-text-gray-500">{{ __('Topic Title') }}</dt>
                        <dd class="tw-mt-1 tw-text-sm tw-text-gray-900 sm:tw-mt-0 sm:tw-col-span-2">
                            <a href="{{ route('admin.topics.show', $reply->topic) }}" class="tw-text-indigo-600 hover:tw-text-indigo-900 hover:tw-underline">
                                {{ $reply->topic->title ?? __('N/A') }}
                            </a>
                        </dd>
                    </div>
                    <div class="tw-py-4 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        <dt class="tw-text-sm tw-font-medium tw-text-gray-500">{{ __('Author') }}</dt>
                        <dd class="tw-mt-1 tw-text-sm tw-text-gray-900 sm:tw-mt-0 sm:tw-col-span-2">{{ $reply->user->name ?? __('N/A') }}</dd>
                    </div>
                    <div class="tw-py-4 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        <dt class="tw-text-sm tw-font-medium tw-text-gray-500">{{ __('Created At') }}</dt>
                        <dd class="tw-mt-1 tw-text-sm tw-text-gray-900 sm:tw-mt-0 sm:tw-col-span-2">{{ $reply->created_at->format('Y/m/d H:i:s') }}</dd>
                    </div>
                    <div class="tw-py-4 sm:tw-grid sm:tw-grid-cols-3 sm:tw-gap-4 sm:tw-px-6">
                        <dt class="tw-text-sm tw-font-medium tw-text-gray-500">{{ __('Updated At') }}</dt>
                        <dd class="tw-mt-1 tw-text-sm tw-text-gray-900 sm:tw-mt-0 sm:tw-col-span-2">{{ $reply->updated_at->format('Y/m/d H:i:s') }}</dd>
                    </div>
                </dl>
            </div>
        </div>

...
@section('description', __('Categories Overview'))
...
@section('content')
    <div class="tw-bg-white tw-shadow-xl sm:tw-rounded-lg tw-p-6">
        ...
        @if ($categories->isEmpty())
            <p class="tw-text-center tw-text-gray-500 tw-mt-8 tw-py-4 tw-bg-gray-50 tw-rounded-lg tw-border tw-border-gray-200">{{ __('No categories found.') }}</p>
        @else
                    ...
                    @foreach ($categories as $category)
                        <tr class="hover:tw-bg-gray-50 tw-transition-colors tw-duration-150">
                            ...
                            <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap tw-text-sm tw-text-gray-500">
                                {{ Str::limit($category->description ?? __('N/A'), 80, '...') }}
                            </td>
                            <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap tw-text-sm tw-text-gray-500">
                                {{ $category->post_count }}
                            </td>
